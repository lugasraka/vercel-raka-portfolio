...
export const projects: Project[] = [
  ...
  {
    slug: "retrofit-recommender",
    title: "Retrofit-Recommender — AI Industrial Sustainability Platform",
    summary:
      "AI module that detects equipment anomalies, diagnoses root causes via LLM + multi-agent orchestration, and recommends specific Siemens hardware products or service packages. Every output includes quantified CO2e avoided, TCO, payback, and compliance mapping (GHG Protocol, CDP, TCFD).",
    year: "2025",
    role: "AI PM & developer",
    tags: [
      "Python",
    ...
    kind: "ai-pm",
    liveUrl: "https://retrofit-recommender-aimlrag.streamlit.app/",
    githubUrl: "https://github.com/lugasraka/Retrofit-recommender",
    body: "",
  },
  {
